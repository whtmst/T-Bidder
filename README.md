...
### 🇺🇸 Версия с латиницей (альтернативная)  
...
**📥 Скачать версию:** [Версия с латиницей (альтернативная)](https://github.com/whtmst/T-Bidder/tree/english)
...
> **Примечание:** Если у вас возникают проблемы с отображением русского текста даже после установки шрифтов, попробуйте [версию аддона с латиницей](https://github.com/whtmst/T-Bidder/tree/english).

### Способ 1: Архив Fonts.rar (рекомендуется)
